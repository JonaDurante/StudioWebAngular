import { AfterViewInit, Component, ElementRef, input, OnInit, Renderer2, signal, ViewChild } from '@angular/core';
...
if(this.heroSection){
  this.renderer.setStyle(this.heroSection.nativeElement, 'background-image', `url(${this.imageUrl()})`)
}
  }
}
